...
Handling application binary interface (ABI) migrations have always been a hassle for Conda-Forge.
...
If a package needs a change in both pins then the maintainers can choose the order in which that apply the pins
